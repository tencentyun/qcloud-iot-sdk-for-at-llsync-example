...
#define QCLOUD_IOT_DEVICE_SDK_VERSION "3.2.1"
...
/* MAX size of product ID */
#define MAX_SIZE_OF_PRODUCT_REGION (24)

#define DEFAULT_HOST_REGION  "ap-guangzhou"
#define US_EAST_HOST_REGION  "na-ashburn"
